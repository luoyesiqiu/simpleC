...
package jackpal.term.shortcuts;
...
import jackpal.term.R;
import jackpal.term.RemoteInterface;
import jackpal.term.RunShortcut;
import jackpal.term.TermDebug;
import jackpal.term.compat.AlertDialogCompat;
import jackpal.term.compat.PRNGFixes;
import jackpal.term.util.ShortcutEncryption;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), jackpal.term.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(jackpal.term.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, jackpal.term.R.drawable.ic_launcher)
               );
             }
