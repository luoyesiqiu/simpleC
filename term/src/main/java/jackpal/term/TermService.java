...
import jackpal.term.compat.ServiceForegroundCompat;
import jackpal.term.libtermexec.v1.*;
import jackpal.term.util.SessionList;
import jackpal.term.util.TermSettings;
...
public class TermService extends Service implements TermSession.FinishCallback
{
    ...
    public void onCreate() {
        ...
        String defValue = this.getFilesDir().getAbsolutePath();//getDir("HOME", MODE_PRIVATE).getAbsolutePath();
...
//        Notification notification = new Notification.Builder(R.drawable.ic_stat_service_notification_icon, getText(R.string.service_notify_text), System.currentTimeMillis());
