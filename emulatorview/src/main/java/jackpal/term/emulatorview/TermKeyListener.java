...
import jackpal.term.emulatorview.compat.AndroidCompat;
import jackpal.term.emulatorview.compat.KeyCharacterMapCompat;
...
import static jackpal.term.emulatorview.compat.KeycodeConstants.*;
...
//        mAppKeyCodes[KEYCODE_DPAD_LEFT] = "\033OD";
    ...
    public void keyDown(int keyCode, KeyEvent event, boolean appMode,
        ...
        if (LOG_KEYS) {
            System.out.println( "keyDown(" + keyCode + "," + event + "," + appMode + "," + allowToggle + ")");
        }
        ...
        default: {
            ...
            if ((result & KeyCharacterMap.COMBINING_ACCENT) != 0) {
                if (LOG_COMBINING_ACCENT) {
                    System.out.println( "Got combining accent " + result);
                }
            ...
            if (mCombiningAccent != 0) {
                ...
                if (LOG_COMBINING_ACCENT) {
                    System.out.println( "getDeadChar(" + mCombiningAccent + ", " + unaccentedChar + ") -> " + result);
                }
                mCombiningAccent = 0;
            }
    ...
    static boolean isEventFromToggleDevice(KeyEvent event) {
       ...
       // System.out.println("----------->getDeviceId:"+event.getDeviceId());
